...
class MedicalGraphData:
    ...
    def load_data(self):
        ...
        self.df_symptom['test_name'] = self.df_symptom['test_name'].astype(str).str.strip()
        ...
        self.organs = sorted([x for x in self.df_symptom['organ'].unique() if pd.notna(x)])
